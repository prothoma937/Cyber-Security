 ...
 * 3) Receives server's DH public key, sends its own.
 * 4) Derives the AES key and exchanges encrypted messages.
 */
public class ClientGUI extends JFrame {
    ...
    public ClientGUI() {
        super("DH Client — Secure Key Exchange (AES-GCM)");
    ...
    private void buildUI() {
        ...
        portField = new JTextField("5000", 7);
        top.add(portField);
    ...
    private void onConnect() {
        ...
        new Thread(() -> {
            try {
                ...
                // Start reader thread
                new Thread(this::listenLoop, "Client-Listen").start();
